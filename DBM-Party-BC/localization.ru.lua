...
L:SetOptionLocalization({
	...
	timerHeathen		= "Отсчет времени до Стража-язычника",
	warnReaver			= "Показывать предупреждение для Стражника-разорителя",
	timerReaver			= "Отсчет времени до Стражника-разорителя",
	warnSharpShooter	= "Показывать предупреждение для Меткого стрелка-страж",
	timerSharpShooter	= "Отсчет времени до Меткого стрелка-стража"
})
...
L:SetOptionLocalization({
    ...
    timerFelCrystal		= "Отсчет времени до Кристалла Скверны"
})
