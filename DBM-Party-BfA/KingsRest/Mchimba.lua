...
if DBM:IsPostMidnight() then
	...
	--local timerBurnCorruptionCD			= mod:NewCDCountTimer(0, 267639, nil, "Melee", nil, 2, nil, DBM_COMMON_L.TANK_ICON..DBM_COMMON_L.DEADLY_ICON)
	--local timerDrainFluidsCD			= mod:NewCDCountTimer(0, 267618, nil, nil, nil, 3)
	...
	local function setFallback(self, dontSetAlerts)
		if not dontSetAlerts then
			--specWarnBurnCorruption:SetAlert(0, "justrun", 2)
			--specWarnDrainFluids:SetAlert(0, "targetyou", 2)
			--specWarnDrainFluidsTarget:SetAlert(0, "healfull", 2)
			--specWarnEntomb:SetAlert(0, "targetyou", 2)
			--specWarnEntombOther:SetAlert(0, "targetchange", 2)
			--specWarnWretchedDischarge:SetAlert(0, "kickcast", 2)
		end
		local onlyColor = not DBM.Options.HideDBMBars and not badStateDetected
		--timerBurnCorruptionCD:SetTimeline(0, onlyColor)
		--timerDrainFluidsCD:SetTimeline(0, onlyColor)
		--timerEntombCD:SetTimeline(0, onlyColor)
	end
