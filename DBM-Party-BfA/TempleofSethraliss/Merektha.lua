...
if DBM:IsPostMidnight() then
	...
	local function setFallback(self, dontSetAlerts)
		if not dontSetAlerts then
			...
			--specWarnNoxiousBreath:SetAlert(0, "watchstep", 2)
			--specWarnBlindingSand:SetAlert(0, "turnaway", 2)
			--specWarnKnotofSnakes:SetAlert(0, "killmob", 2)
			--specWarnKnotofSnakesYou:SetAlert(0, "targetyou", 2)
		end
		local onlyColor = not DBM.Options.HideDBMBars and not badStateDetected
		--timerNoxiousBreathCD:SetTimeline(0, onlyColor)
		--timerHatch:SetTimeline(0, onlyColor)
	end
