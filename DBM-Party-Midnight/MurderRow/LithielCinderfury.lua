...
do
	...
	local function timersAll(self, timer, timerExact, eventID)
		...
		elseif timer == 24 or timer == 59 then
			--Blizzards timer is actually a bit more variable with confirmedd 55.1-59 range
			timerMaleficWaveCD:TLStart(timer == 59 and "v55.1-59" or timerExact, eventID, self:TLCountStart(eventID, "wave", "waveCount"))
			return true
		end
	end
