...
mod:AddAuraSoundOption(1247233, true, 1247233, 1, 1, "scatter", 2, 0)--Earthquake (targeted)
mod:AddAuraSoundOption(1247367, true, 1247233, 1, 2, "watchfeet", 8, 0)--Earthquake
...
function mod:GOSSIP_SHOW()
	...
	if gossipOptionID then
		--Two npcs that port you to new area
		if self.Options.AutoGossipAction and (gossipOptionID == 135010 or gossipOptionID == 135009) then
