...
--Torghast
local specWarnHowlingSouls			= mod:NewSpecialWarningSpell(215710, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnMassiveStrike			= mod:NewSpecialWarningDodge(292903, nil, nil, nil, 2, 2, nil, nil, "shockwave")
local specWarnMeteor				= mod:NewSpecialWarningDodge(270264, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnRatTrap				= mod:NewSpecialWarningDodge(295942, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnFanningtheFlames		= mod:NewSpecialWarningDodge(308026, nil, nil, nil, 2, 2, nil, nil, "shockwave")
local specWarnCrushingSlam			= mod:NewSpecialWarningDodge(329908, nil, nil, nil, 2, 2, nil, nil, "shockwave")
local specWarnProphecyOfDeath		= mod:NewSpecialWarningDodge(330471, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnDiscordantBarrage		= mod:NewSpecialWarningDodge(294401, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnBindSouls				= mod:NewSpecialWarningDodge(297020, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnInferno				= mod:NewSpecialWarningDodge(335528, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnCarrionSwarm			= mod:NewSpecialWarningDodge(353573, nil, nil, nil, 2, 2, nil, nil, "shockwave")
local specWarnTorturingSwipe		= mod:NewSpecialWarningDodge(354490, nil, nil, nil, 2, 2, nil, nil, "shockwave")
local specWarnQuake					= mod:NewSpecialWarningJump(81008, nil, nil, nil, 2, 2, nil, nil, "jumpnow")

local specWarnGroundCrush			= mod:NewSpecialWarningRun(295985, nil, nil, nil, 4, 2, nil, nil, "justrun")
--local specWarnMightySlam			= mod:NewSpecialWarningRun(296748, nil, nil, nil, 4, 2)
local specWarnWhirlwind				= mod:NewSpecialWarningRun(295001, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnSoulblastNova			= mod:NewSpecialWarningRun(294533, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnCrushingStomp			= mod:NewSpecialWarningRun(329909, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnPainBringer			= mod:NewSpecialWarningRun(351931, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnDeafeningHowl			= mod:NewSpecialWarningCast(296523, "SpellCaster", nil, nil, 1, 2, nil, nil, "stopcast")
local specWarnBoneShrapnel			= mod:NewSpecialWarningStack(303678, nil, 4, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnMassCripple			= mod:NewSpecialWarningDispel(304093, "RemoveMagic", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnCurseofFrailtyDispel	= mod:NewSpecialWarningDispel(294526, "RemoveCurse", nil, nil, 1, 2, nil, nil, "helpdispel")
--local yellScorchedFeet			= mod:NewYell(315385)
local specWarnNecroticBolt			= mod:NewSpecialWarningInterrupt(288210, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnShadowBoltVolley		= mod:NewSpecialWarningInterrupt(294362, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnBindofFallen			= mod:NewSpecialWarningInterrupt(304075, false, nil, 2, 1, 2, nil, nil, "kickcast")
local specWarnConflagrate			= mod:NewSpecialWarningInterrupt(270248, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnFireballVolley		= mod:NewSpecialWarningInterrupt(270348, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnTerrifyingRoar		= mod:NewSpecialWarningInterrupt(263085, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnCurseofFrailty		= mod:NewSpecialWarningInterrupt(294526, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnFearsomeHowl			= mod:NewSpecialWarningInterrupt(298844, "HasInterrupt", nil, 2, 1, 2, nil, nil, "kickcast")
local specWarnFearsomeShriek		= mod:NewSpecialWarningInterrupt(332165, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnTerrifyingScreech		= mod:NewSpecialWarningInterrupt(329930, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnPhasingRoar			= mod:NewSpecialWarningInterrupt(294517, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnDeathBlast			= mod:NewSpecialWarningInterrupt(296839, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnAccursedStrength		= mod:NewSpecialWarningInterrupt(294165, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnWitheringRoar			= mod:NewSpecialWarningInterrupt(330118, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnInnerFlames			= mod:NewSpecialWarningInterrupt(258935, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnSoulofMist			= mod:NewSpecialWarningInterrupt(277040, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnTerror				= mod:NewSpecialWarningInterrupt(242391, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnBountyOfTheForest		= mod:NewSpecialWarningInterrupt(330573, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnShadowboltVolley		= mod:NewSpecialWarningInterrupt(353769, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnPersecute				= mod:NewSpecialWarningInterrupt(351090, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnSoulofMistDispel		= mod:NewSpecialWarningDispel(277040, "MagicDispeller", nil, nil, 1, 2, nil, nil, "helpdispel")
