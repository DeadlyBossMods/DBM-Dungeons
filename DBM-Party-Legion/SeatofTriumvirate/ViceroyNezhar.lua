...
if DBM:IsPostMidnight() then
	...
	mod:AddPrivateAuraSoundOption(1263542, false, 1263542, 1, "debuffyou", 17)--Mass Void Infusion (just minor rot damage, off by default)
	mod:AddPrivateAuraSoundOption(1263532, true, 1263532, 1, "watchfeet", 8)--Void Storm (GTFO)
