...
L:SetMiscLocalization({
	...
	SpyGoingAway				= "Шпион-помощник, скорее всего, исчезнет в патче 10.0.7. Следует пользоваться помощью Охотников на демонов или голосовую связь для этого подземелья, как и предполагалось Blizzard",
