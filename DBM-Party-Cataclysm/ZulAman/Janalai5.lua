...
local specWarnFlameBreath	= mod:NewSpecialWarningMove(97497, nil, nil, nil, 1, 2, nil, nil, "runaway")
local specWarnAdds			= mod:NewSpecialWarningSpell(43962, nil, nil, nil, 1, 2, nil, nil, "mobsoon")
local specWarnBomb			= mod:NewSpecialWarningDodge(42630, nil, nil, nil, 2, nil, nil, nil, "watchstep")
local specWarnHatchAll		= mod:NewSpecialWarningSpell(43144, "Tank", nil, nil, 1, 2, nil, nil, "mobsoon")
