...
local specWarnSpoutingStout					= mod:NewSpecialWarningCount(439365, nil, nil, nil, 1, 2, nil, nil, "watchstep")
--local yellSomeAbility						= mod:NewYell(372107)
local specWarnBurningFermentation			= mod:NewSpecialWarningYou(439202, false, nil, nil, 1, 17, nil, nil, "debuffyou")
local specWarnBottomsUppercut				= mod:NewSpecialWarningDefensive(439031, nil, nil, nil, 1, 2, nil, nil, "carefly")
local specWarnGTFO							= mod:NewSpecialWarningGTFO(441179, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
